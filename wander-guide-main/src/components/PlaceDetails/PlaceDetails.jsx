...
const PlaceDetails=({ place, selected, refProp }) => {
    ...
    return (
        <Card elevation={6}>
            <CardMedia 
                style={{height: 350}}
                image={place.photo ? place.photo.images.large.url : 'https://img.freepik.com/free-photo/restaurant-interior_1127-3394.jpg'}
                title={place.name}
            />
            <CardContent>
                ...
                {place?.awards?.map((award) =>(
                    <Box my={1} display="flex" justifyContent="space-between+-2=1" alignItems="center">
